...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { name: @gallery.name, property_id: @gallery.property_id } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { name: @gallery.name, property_id: @gallery.property_id } }
