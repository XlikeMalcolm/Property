...
class PurchaseTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_type" do
    assert_difference('PurchaseType.count') do
      post purchase_types_url, params: { purchase_type: { listing_id: @purchase_type.listing_id, name: @purchase_type.name } }
    end
  ...
  test "should update purchase_type" do
    patch purchase_type_url(@purchase_type), params: { purchase_type: { listing_id: @purchase_type.listing_id, name: @purchase_type.name } }
